...
try:
    ...
    st.set_page_config(page_title="SniffIt | Energy Theft AI", page_icon=fav_icon, layout="wide")
except Exception:
    st.set_page_config(page_title="SniffIt | Energy Theft AI", page_icon="🐘", layout="wide")
...
st.markdown("""
    ...
    .logo-img { border-radius: 50%; width: 150px; height: 150px; object-fit: cover; border: 4px solid #D4AF37; }
    </style>
